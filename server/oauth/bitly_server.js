    ...
    response = HTTP.post(
      "https://api-ssl.bitly.com/oauth/access_token", {
        ...
        params: {
          ...
          redirect_uri: OAuth._redirectUri('bitly', config), //, {replaceLocalhost: true}),
...
Bitly.retrieveCredential = function(credentialToken, credentialSecret) {
